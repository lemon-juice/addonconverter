...
<form action="convert.php" method="post" enctype="multipart/form-data">
	...
	<div class="info">
		...
		<p>For trying out an extension in most cases it is best to leave the default options unchanged. For Thunderbird extensions uncheck the last two options regarding Firefox-specific stuff. Sometimes, this tool can do too much so in case of problems you may try to play with the options &mdash; remember this tool is mostly dumb and except for updating install.rdf it does not parse nor interpret the source code &mdash; it only does some basic string replacements. It most cases this will work, but sometimes it can produce broken code and unusable add-on. However, after the conversion you will be able to see the diff of changed files &mdash; handy for the more experienced users.</p>
